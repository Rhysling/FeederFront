...
<Container>
	...
	<p>
		TwitFeeder (the "Company") is committed to maintaining robust privacy
	...
	<p>
		...
		which can be accessed at <a href="https://twitfeeder.com"
			>https://twitfeeder.com</a
		>.
	</p>

	<p>
		"Service" refers to the Company's services accessed via the Site, in which
		users can obtain RSS feeds for Twitter user timelines and other feed
		sources.
	</p>
	...
	<p>
		...
		Terms of Use (found here: <a href="https://twitfeeder.com/terms-of-service"
			>https://twitfeeder.com/terms-of-service</a
	...
	<p>
		...
		username, and any other information which you submit to us through the
		registration process at the Site or that is made available to us by the
		third-party authentication provider you choose.
	</p>

	<h3>1. Information collected via Technology</h3>

	<p>
		You do not need to submit any Personal Information to use the publicly
		available features of the Service. To use features of the Service
		customizable to you, you must create an account with the Service and
		authenticate yourself before gaining access to those features. However, in
		an effort to improve the quality of the Service, we track information
		provided to us by your browser or by our software application when you view
		or use the Service, such as the website you came from (known as the
		"referring URL"), the type of browser you use, the device from which you
		connected to the Service, the time and date of access, and other information
		that does not personally identify you. We track this information using
		cookies, or small text files which include an anonymous unique identifier.
		Cookies are sent to a user's browser from our servers and are stored on the
		user's computer hard drive. Sending a cookie to a user's browser enables us
		to collect Non-Personal information about that user and keep a record of the
		user's preferences when utilizing our services, both on an individual and
		aggregate basis.
	</p>
	...
	<p>
		...
		you visit the Site, to use personalized features of the Service you will
		need to create an account. The Service uses Auth0 Inc. ("Auth0") for account
		registration and to authenticate you prior to using these features. By
		registering for the Service and each time you authenticate with the Service
		you accept the privacy policy and other terms and conditions of Auth0, all
		of which may be found here: <a
			href="https://auth0.com/"
			target="_blank"
			rel="noreferrer">https://auth0.com</a
		>. When registering you may choose to either create a username and password
		for the Service or to use a third-party authentication service (such as
		Google or Twitter) where you have an account. By registering, you are
		authorizing us to collect, store and use the information you provide and any
		information made available to us by a third-party authentication service you
		select in accordance with this Privacy Policy.
	</p>

	<h3>3. Children's Privacy</h3>

	<p>
		The Site and the Service are not directed to anyone under the age of 13. The
		Site does not knowingly collect or solicit information from anyone under the
		age of 13 or allow anyone under the age of 13 to sign up for the Service. If
		we learn that we have gathered personal information from anyone under the
		...
		information, please contact us at twitfeeder@polson.com.
	</p>
	...
	<p>
		...
		technical support, and inform users about promotional offers. We may share
		...
		investigation of potential violations; address fraud, security or technical
		concerns; or to protect against harm to the rights, property, or safety of
	...
	<p>
		...
		Information to track trends and analyze use patterns on the Site. This
		Privacy Policy does not limit in any way our use or disclosure of Non-
		Personal Information and we reserve the right to use and disclose such
	...
	<p>
		...
		to the Site so that you may opt out of the new information practices. We
		suggest that you check the Site periodically if you are concerned about how
	...
	<p>
		...
		unauthorized access. Your account is protected by your account password or
		the processes of the third-party authentication provider you select, and we
		urge you to take steps to keep your personal information safe by not
		...
		firewalls, and secure socket layer technology. However, these measures do
		not guarantee that your information will not be accessed, disclosed,
	...
	<p>
		...
		marketing purposes. When we send a promotional communication to a user, the
		user can opt out of further promotional communications by following the
		unsubscribed instructions provided in each promotional e-mail. You can also
		indicate that you do not wish to receive marketing communications by
		notifying us at twitfeeder@polson.com. Please note that notwithstanding the
		promotional preferences you indicate, we may continue to send you
	...
	<p>
		...
		your account (if provided) or by placing a prominent notice on our site.
	...
	<p>
		...
		this Site, please contact us by sending an email to twitfeeder@polson.com.
	</p>
